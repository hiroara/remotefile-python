...
def parse_args():
    ...
    argparser.set_defaults(arguments='', verbose=False, port=8000, use_cache=False)
...
def main():
    ...
    Runner(args.script, cache_dir='/tmp/src', region_name=args.region).exec_script(*args.arguments.split(' '), force=(not args.use_cache))
